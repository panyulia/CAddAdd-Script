...
var log=function(text,date){console.log(text,date);}
var warn=function(text,date){console.warn(text,date);}
var error=function(text,date){console.error(text,date);}
function createXHR () {
    var XHR = [
